...
/**
 * SeekBarPreference is a custom made Preference that uses a seekbar (slider)
 * to implement a user preference
 *
 * @author Ragger
 */
...
public class SeekBarPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        ...
        mMax = attrs.getAttributeIntValue(androidns, "max", 26);
    }
